/**
 * An encryption algorithm that combines hashing algorithm and hash data warehouse.
 *
 * Hash cube:
 *
 ...
 *
 *  2. Add fields plaintext in order to add length (1 byte), checksum (1 byte)
 *  and padding in order to length be a number that is multiple of number 3.
 *
 *              +-- length (5)                          +--------+--- padding
 *              |                                       |        |
 ...
 *
 *     a) Get length of plaintext Check checksum.
 *     b) Validate length
 *     c) Validate padding
 *     d) Validate checksum
 *     d) Extract the plaintext P = "Hello"
 *
 * Fusnotes:
 *
